...
//      val prefs = BuyerPreferences(Set("male", "tabby")) Logic
//      .matchLikelihood(tabby, prefs) must beGreaterThan(0.999)
//    }
//    "be 0% when no attributes match" in {
//      val tabby = Kitten(1, Set("male", "tabby"))
//      val prefs = BuyerPreferences(Set("female", "calico"))
//      val result = Logic.matchLikelihood(tabby, prefs) result must beLessThan (0.001)
//    }
//  }
//}